...
from Nobita_X_Robot import EVENT_LOGS,OWNER_ID, SUPPORT_CHAT, dispatcher
...
def export_data(update, context):
    ...
    with open("Nobita_X_Robot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Nobita_X_Robot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Nobita_X_Robot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Nobita_X_Robot{}.backup".format(chat_id))  # Cleaning file
