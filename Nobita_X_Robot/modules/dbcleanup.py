...
import Nobita_X_Robot.modules.sql.global_bans_sql as gban_sql
import Nobita_X_Robot.modules.sql.users_sql as user_sql
from Nobita_X_Robot import DEV_USERS, OWNER_ID, dispatcher
